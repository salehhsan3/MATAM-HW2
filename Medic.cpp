...
namespace mtm
{
    ...
    void Medic::attack(std::shared_ptr<Character> main_target,const GridPoint & src_coordinates,
    ...
    void Medic::attackNearByPlayerIfYouHaveTheAbility(std::shared_ptr<Character> temp_target,
