...
namespace mtm
{
    ...
    void Sniper::attack(std::shared_ptr<Character> main_target,const GridPoint & src_coordinates,
    ...
    void Sniper::attackNearByPlayerIfYouHaveTheAbility(std::shared_ptr<Character> temp_target,
